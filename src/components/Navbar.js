...
const Navbar = () => {
    ...
    const menuItems = <>
        <li><a href='/' as={Link} className='text-primary font-medium hover:text-secondary'>Home</a></li>
        ...
        <nav>
            <div className="navbar">
                <div className="navbar-start">
                    <a href='/' as={Link} className="btn btn-ghost normal-case text-2xl">DIGITALVISION</a>
                </div>
